...
import 'package:ioasys_projects/app/modules/chuck_norris/presentation/pages/joke/joke_controller.dart';
...
class _JokePageState extends ModularState<JokePage, JokeController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<ChuckJokeModel>(
        future:
            controller.getRandomJokeFromCategory(category: widget.category),
